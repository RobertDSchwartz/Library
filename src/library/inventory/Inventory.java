...
public class Inventory {
	...
	/**
	 * auto incremented counter each time a new animal is create, this field
	 * is only updated by the default constructor.
	 */
	private static int counter = 0;

	/**
	 * Default animal type is Inventory, but this should always get changes
	...
	/**
	 * The animal ID, which is auto generated by a static Class counter.
	 */
	protected int id = 0;
	...
	/**
	 * The animal's type; enum Type values are FEMALE or MALE.
	 */
	 ...
	 */
	public Inventory(int age, Type type, double weight){
	 ...
	 * 
	 * @param age The animals age in years.
	 */
	 ...
	 * 
	 * @return The animal's Type (enum FEMALE or MALE).
	 */
	...
	/**
	 * Set the animal's Type.
	 * 
	 * @param type The animal's Type (enum FEMALE or MALE).
	 */
	public void setGender(Type type) {
		this.type = type; // don't need to validate because we are using an enum
	}
